 ...
 * @returns {any}
 */
export function validate_csv_from_str(cddl, csv_data, has_header, enabled_features) {
    const ptr0 = passStringToWasm0(cddl, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    ...
    var ptr2 = isLikeNone(enabled_features) ? 0 : passArrayJsValueToWasm0(enabled_features, wasm.__wbindgen_malloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.validate_csv_from_str(ptr0, len0, ptr1, len1, isLikeNone(has_header) ? 0xFFFFFF : has_header ? 1 : 0, ptr2, len2);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
